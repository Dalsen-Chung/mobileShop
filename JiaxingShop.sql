...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '管理员用户表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jx_category`  (
  ...
  `icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类图标Url',
  `addtime` int(12) NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `jx_product` VALUES (1, 1, 1, 'Iphonex', '这是广告语', 6666.00, 'images/cover/2020-02-17/5e4a49ec66672.jpg', 'images/cover/2020-02-17/5e4a4a040f7df.jpg,', '这是商品详情', 1000, 1, 1, 1581926923, 1581926923);
INSERT INTO `jx_product` VALUES (2, 1, 1, 'iPhone XS', '这是广告语', 8888.00, 'images/cover/2020-02-17/5e4a4a59f002b.jpg', 'images/cover/2020-02-17/5e4a4a7138aed.jpg,', '这是商品详情', 2000, 1, 0, 1581927029, 1581927029);
