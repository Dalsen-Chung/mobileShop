...
CREATE TABLE `jx_admin_user` (
  ...
  `name` varchar(50) DEFAULT NULL COMMENT '管理员昵称',
  `password` varchar(50) DEFAULT NULL COMMENT '密码',
  `right_id` tinyint(1) DEFAULT NULL COMMENT '权限资源ID',
...
-- ----------------------------
BEGIN;
INSERT INTO `jx_admin_user` VALUES (1, 'admin', '许铭聪', '21232f297a57a5a743894a0e4a801fc3', 1, 1, 1);
COMMIT;
...
CREATE TABLE `jx_brand` (
  ...
  `icon` varchar(255) DEFAULT NULL COMMENT '品牌图标Url',
  `addtime` int(12) DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `jx_category` (
  ...
  `fid` int(11) DEFAULT NULL COMMENT '父级分类ID',
  `name` varchar(255) DEFAULT NULL COMMENT '分类名称',
  `introduction` varchar(255) DEFAULT NULL COMMENT '分类简介',
...
CREATE TABLE `jx_product` (
  ...
  `photo` varchar(100) DEFAULT NULL COMMENT '商品列表图片Url',
  `photo_list` text COMMENT '商品详情图片组，按英文逗号分隔',
...
CREATE TABLE `jx_product_spec` (
  ...
  `desc` varchar(255) DEFAULT NULL COMMENT '商品规格描述',
  `addtime` int(12) DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `jx_user_address` (
  ...
  `uid` int(11) DEFAULT NULL COMMENT '用户ID',
  `receiver` varchar(10) DEFAULT NULL COMMENT '收货人',
  `tel` char(15) DEFAULT NULL COMMENT '收货人电话',
  `address` text COMMENT '地址详情',
...
CREATE TABLE `jx_user_return` (
  ...
  `order_sn` varchar(20) DEFAULT NULL COMMENT '退货订单号',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户退货记录表';
